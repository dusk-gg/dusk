...
We're just added AI to the Rune SDK so that your games can now make use of generative AI responses. As part of getting this release of the SDK out we decided to build out some AI games. So the challenge was set, can we build 7 unique (carefully scoped) AI based in 7 days? Here's what happened and what we learnt during the process. 
